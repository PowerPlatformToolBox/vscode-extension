(function () {
  ...
  function buildPowerPlatformCategoryClient(category) {
    return {
      Get(path = "", connectionTarget = "primary", headers) {
        return invoke("powerplatform", "request", [
          category,
          "GET",
          path,
          undefined,
  ...
  const dataverseAPI = {
    create(entityLogicalName, record, connectionTarget = "primary") {
      return invoke("dataverse", "create", [
        entityLogicalName,
        record,
        connectionTarget,
      ]);
    ...
    retrieve(entityLogicalName, id, columns, connectionTarget = "primary") {
      return invoke("dataverse", "retrieve", [
        entityLogicalName,
        id,
        columns,
        connectionTarget,
    ...
    update(entityLogicalName, id, record, connectionTarget = "primary") {
      return invoke("dataverse", "update", [
        entityLogicalName,
        id,
        record,
        connectionTarget,
    ...
    delete(entityLogicalName, id, connectionTarget = "primary") {
      return invoke("dataverse", "delete", [
        entityLogicalName,
        id,
        connectionTarget,
      ]);
    ...
    getEntityMetadata(
      ...
      return invoke("dataverse", "getEntityMetadata", [
        entityLogicalName,
        searchByLogicalName,
        entityProperties,
        connectionTarget,
    ...
    getAllEntitiesMetadata(entityProperties, connectionTarget = "primary") {
      return invoke("dataverse", "getAllEntitiesMetadata", [
        entityProperties,
        connectionTarget,
      ]);
    },
    getEntityRelatedMetadata(
      ...
      return invoke("dataverse", "getEntityRelatedMetadata", [
        entityLogicalName,
        relatedPath,
        entityProperties,
        connectionTarget,
    ...
    publishCustomizations(tableLogicalName, connectionTarget = "primary") {
      return invoke("dataverse", "publishCustomizations", [
        tableLogicalName,
        connectionTarget,
      ]);
    },
    createMultiple(entityLogicalName, records, connectionTarget = "primary") {
      return invoke("dataverse", "createMultiple", [
        entityLogicalName,
        records,
        connectionTarget,
      ]);
    ...
    updateMultiple(entityLogicalName, records, connectionTarget = "primary") {
      return invoke("dataverse", "updateMultiple", [
        entityLogicalName,
        records,
        connectionTarget,
      ]);
    ...
    getEntitySetName(entityLogicalName, connectionTarget = "primary") {
      return invoke("dataverse", "getEntitySetName", [
        entityLogicalName,
        connectionTarget,
      ]);
    },
    associate(
      ...
      return invoke("dataverse", "associate", [
        primaryEntityName,
        primaryEntityId,
        relationshipName,
        relatedEntityName,
    ...
    disassociate(
      ...
      return invoke("dataverse", "disassociate", [
        primaryEntityName,
        primaryEntityId,
        relationshipName,
        relatedEntityId,
    ...
    deploySolution(base64SolutionContent, options, connectionTarget = "primary") {
      return invoke("dataverse", "deploySolution", [
        base64SolutionContent,
        options,
        connectionTarget,
      ]);
    },
    getImportJobStatus(importJobId, connectionTarget = "primary") {
      return invoke("dataverse", "getImportJobStatus", [
        importJobId,
        connectionTarget,
      ]);
    },
    ...
    createEntityDefinition(entityDefinition, options, connectionTarget = "primary") {
      return invoke("dataverse", "createEntityDefinition", [
        entityDefinition,
        options,
        connectionTarget,
      ]);
    ...
    updateEntityDefinition(
      ...
      return invoke("dataverse", "updateEntityDefinition", [
        entityIdentifier,
        entityDefinition,
        options,
        connectionTarget,
    ...
    deleteEntityDefinition(entityIdentifier, connectionTarget = "primary") {
      return invoke("dataverse", "deleteEntityDefinition", [
        entityIdentifier,
        connectionTarget,
      ]);
    },
    createAttribute(
      ...
      return invoke("dataverse", "createAttribute", [
        entityLogicalName,
        attributeDefinition,
        options,
        connectionTarget,
    ...
    updateAttribute(
      ...
      return invoke("dataverse", "updateAttribute", [
        entityLogicalName,
        attributeIdentifier,
        attributeDefinition,
        options,
    ...
    deleteAttribute(entityLogicalName, attributeIdentifier, connectionTarget = "primary") {
      return invoke("dataverse", "deleteAttribute", [
        entityLogicalName,
        attributeIdentifier,
        connectionTarget,
      ]);
    ...
    createPolymorphicLookupAttribute(
      ...
      return invoke("dataverse", "createPolymorphicLookupAttribute", [
        entityLogicalName,
        attributeDefinition,
        options,
        connectionTarget,
    ...
    createRelationship(relationshipDefinition, options, connectionTarget = "primary") {
      return invoke("dataverse", "createRelationship", [
    ...
    updateRelationship(
      ...
      return invoke("dataverse", "updateRelationship", [
        relationshipIdentifier,
        relationshipDefinition,
        options,
        connectionTarget,
    ...
    deleteRelationship(relationshipIdentifier, connectionTarget = "primary") {
      return invoke("dataverse", "deleteRelationship", [
        relationshipIdentifier,
        connectionTarget,
      ]);
    },
    createGlobalOptionSet(optionSetDefinition, options, connectionTarget = "primary") {
      return invoke("dataverse", "createGlobalOptionSet", [
        optionSetDefinition,
        options,
        connectionTarget,
      ]);
    ...
    updateGlobalOptionSet(
      ...
      return invoke("dataverse", "updateGlobalOptionSet", [
        optionSetIdentifier,
        optionSetDefinition,
        options,
        connectionTarget,
    ...
    deleteGlobalOptionSet(optionSetIdentifier, connectionTarget = "primary") {
      return invoke("dataverse", "deleteGlobalOptionSet", [
        optionSetIdentifier,
        connectionTarget,
      ]);
    },
